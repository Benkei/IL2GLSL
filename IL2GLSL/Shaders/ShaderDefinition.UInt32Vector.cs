...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		public sealed class uvec2
		{
			...
			public static uvec2 operator + ( uvec2 v1, uvec2 v2 )
			{
			...
			public static uvec2 operator * ( uvec2 v1, uint s )
			{
				throw _invalidAccess;
			}
			...
			public static uvec2 operator - ( uvec2 v )
			{
				throw _invalidAccess;
			}

			public uvec2 ( uint xy )
			{
				throw _invalidAccess;
			}
		...
		public sealed class uvec3
		{
			...
			public static uvec3 operator - ( uvec3 v, uvec3 m )
			{
				throw _invalidAccess;
			}
			...
			public static uvec3 operator * ( uvec3 v, uint d )
			{
				throw _invalidAccess;
			}
			...
			public static uvec3 operator - ( uvec3 v )
			{
				throw _invalidAccess;
			}

			public uvec3 ( uint xyz )
			{
				throw _invalidAccess;
			}
		...
		public sealed class uvec4
		{
			...
			public static uvec4 operator - ( uvec4 v, uvec4 m )
			{
				throw _invalidAccess;
			}
			...
			public static uvec2 operator / ( uvec4 v, uint s )
			{
				throw _invalidAccess;
			}

			public static uvec4 operator + ( uvec4 v, uint s )
			{
				throw _invalidAccess;
			}
			...
			public static uvec4 operator - ( uvec4 v )
			{
				throw _invalidAccess;
			}

			public uvec4 ( uint xyzw )
			{
				throw _invalidAccess;
			}
			...
			public uvec4 ( uint x, uvec2 yz, uint w )
			{
				throw _invalidAccess;
			}

			public uvec4 ( uint x, uint y, uvec2 zw )
			{
				throw _invalidAccess;
			}

			public uvec4 ( uvec2 xy, uvec2 zw )
			{
				throw _invalidAccess;
			}
