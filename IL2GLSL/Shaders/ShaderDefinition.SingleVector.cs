...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		...
		public sealed class vec3
		{
			...
			public static vec3 operator * ( vec3 v, float d )
			{
				throw _invalidAccess;
			}
			...
			public static vec3 operator / ( vec3 v, vec3 d )
			{
				throw _invalidAccess;
			}

			public static vec3 operator % ( vec3 v1, vec3 v3 )
			{
				throw _invalidAccess;
			}

			public static vec3 operator % ( vec3 v1, float d )
			{
				throw _invalidAccess;
			}
		...
		public sealed class vec4
		{
			...
			public static vec4 operator - ( vec4 v, vec4 m )
			{
				throw _invalidAccess;
			}
			...
			public static vec4 operator / ( vec4 v, vec4 s )
			{
				throw _invalidAccess;
			}
			...
			public static vec4 operator % ( vec4 v1, float s )
			{
				throw _invalidAccess;
			}
