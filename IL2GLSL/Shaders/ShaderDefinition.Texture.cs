...
namespace IIS.SLSharp.Shaders
{
	...
	public abstract partial class ShaderDefinition
	{
		...
		#endregion int TextureSize (gsampler1D sampler, int lod)
		...
		#endregion ivec2 TextureSize (gsampler2D sampler, int lod)
		...
		#endregion ivec3 TextureSize (gsampler3D sampler, int lod)
		...
		#endregion ivec2 TextureSize (gsamplerCube sampler, int lod)
		...
		#endregion int TextureSize (sampler1DShadow sampler, int lod)
		...
		#endregion ivec2 TextureSize (sampler2DShadow sampler, int lod)
		...
		#endregion ivec2 TextureSize (samplerCubeShadow sampler, int lod)
		...
		#endregion ivec2 TextureSize (gsampler2DRect sampler)

		#endregion TextureSize
		...
		#endregion vec2 TextureQueryLod(gsampler1D sampler, float P)
		...
		#endregion vec2 TextureQueryLod(gsampler2D sampler, vec2 P)
		...
		#endregion vec2 TextureQueryLod(gsampler3D sampler, vec3 P)
		...
		#endregion vec2 TextureQueryLod(gsamplerCube sampler, vec3 P)
		...
		#endregion vec2 TextureQueryLod(sampler1DShadow sampler, float P)
		...
		#endregion vec2 TextureQueryLod(sampler2DShadow sampler, vec2 P)
		...
		#endregion vec2 TextureQueryLod(samplerCubeShadow sampler, vec3 P)

		#endregion TextureQueryLod
		...
		#endregion gvec4 Texture (gsampler1D sampler, float P [, float bias] )
		...
		#endregion gvec4 Texture (gsampler2D sampler, vec2 P [, float bias] )
		...
		#endregion gvec4 Texture (gsampler3D sampler, vec3 P [, float bias] )
		...
		#endregion gvec4 Texture (gsamplerCube sampler, vec3 P [, float bias] )
		...
		#endregion float Texture (sampler1DShadow sampler, vec3 P [, float bias] )
		...
		#endregion float Texture (sampler2DShadow sampler, vec3 P [, float bias] )
		...
		#endregion float Texture (samplerCubeShadow sampler, vec4 P [, float bias] )
		...
		#endregion gvec4 Texture (gsampler2DRect sampler, vec2 P)
		...
		#endregion gvec4 TextureProj (gsampler1D sampler, vec2 P [, float bias] )
		...
		#endregion gvec4 TextureProj (gsampler1D sampler, vec4 P [, float bias] )
		...
		#endregion gvec4 TextureProj (gsampler2D sampler, vec3 P [, float bias] )
		...
		#endregion gvec4 TextureProj (gsampler2D sampler, vec4 P [, float bias] )
		...
		#endregion gvec4 TextureProj (gsampler3D sampler, vec4 P [, float bias] )
		...
		#endregion float TextureProj (sampler1DShadow sampler, vec4 P [, float bias] )
		...
		#endregion float TextureProj (sampler2DShadow sampler, vec4 P [, float bias] )
		...
		#endregion gvec4 TextureProj (gsampler2DRect sampler, vec3 P)
		...
		#endregion gvec4 TextureProj (gsampler2DRect sampler, vec4 P)
		...
		#endregion float TextureProj (sampler2DRectShadow sampler, vec4 P)

		#endregion TextureProj
		...
		#endregion gvec4 TextureLod (gsampler1D sampler, float P, float lod)
		...
		#endregion gvec4 TextureLod (gsampler2D sampler, vec2 P, float lod)
		...
		#endregion gvec4 TextureLod (gsampler3D sampler, vec3 P, float lod)
		...
		#endregion gvec4 TextureLod (gsamplerCube sampler, vec3 P, float lod)
		...
		#endregion float TextureLod (sampler1DShadow sampler, vec3 P, float lod)
		...
		#endregion float TextureLod (sampler2DShadow sampler, vec3 P, float lod)

		#endregion TextureLod
		...
		#endregion gvec4 TextureOffset (gsampler1D sampler, float P, int offset [, float bias] )
		...
		#endregion gvec4 TextureOffset (gsampler2D sampler, vec2 P, ivec2 offset [, float bias] )
		...
		#endregion gvec4 TextureOffset (gsampler3D sampler, vec3 P, ivec3 offset [, float bias] )
		...
		#endregion gvec4 TextureOffset (gsampler2DRect sampler, vec2 P, ivec2 offset )
		...
		#endregion float TextureOffset (sampler2DRectShadow sampler, vec3 P, ivec2 offset )
		...
		#endregion float TextureOffset (sampler1DShadow sampler, vec3 P, int offset [, float bias] )
		...
		#endregion float TextureOffset (sampler2DShadow sampler, vec3 P, ivec2 offset [, float bias] )
		...
		#endregion gvec4 TexelFetch (gsampler1D sampler, int P, int lod)
		...
		#endregion gvec4 TexelFetch (gsampler2D sampler, ivec2 P, int lod)
		...
		#endregion gvec4 TexelFetch (gsampler3D sampler, ivec3 P, int lod)
		...
		#endregion gvec4 TexelFetch (gsampler2DRect sampler, ivec2 P)

		#endregion TexelFetch
		...
		#endregion gvec4 TexelFetchOffset (gsampler1D sampler, int P, int lod, int offset)
		...
		#endregion gvec4 TexelFetchOffset (gsampler2D sampler, ivec2 P, int lod, ivec2 offset)
		...
		#endregion gvec4 TexelFetchOffset (gsampler3D sampler, ivec3 P, int lod, ivec3 offset)
		...
		#endregion gvec4 TexelFetchOffset (gsampler2DRect sampler, ivec2 P, ivec2 offset)

		#endregion TexelFetchOffset
		...
		#endregion gvec4 TextureProjOffset (gsampler1D sampler, vec2 P, int offset [, float bias] )
		...
		#endregion gvec4 TextureProjOffset (gsampler1D sampler, vec4 P, int offset [, float bias] )
		...
		#endregion gvec4 TextureProjOffset (gsampler2D sampler, vec3 P, ivec2 offset [, float bias] )
		...
		#endregion gvec4 TextureProjOffset (gsampler2D sampler, vec4 P, ivec2 offset [, float bias] )
		...
		#endregion gvec4 TextureProjOffset (gsampler3D sampler, vec4 P, ivec3 offset [, float bias] )
		...
		#endregion gvec4 TextureProjOffset (gsampler2DRect sampler, vec3 P, ivec2 offset )
		...
		#endregion gvec4 TextureProjOffset (gsampler2DRect sampler, vec4 P, ivec2 offset )
		...
		#endregion float TextureProjOffset (sampler2DRectShadow sampler, vec4 P, ivec2 offset )
		...
		#endregion float TextureProjOffset (sampler1DShadow sampler, vec4 P, int offset [, float bias] )
		...
		#endregion float TextureProjOffset (sampler2DShadow sampler, vec4 P,ivec2 offset [, float bias] )

		#endregion TextureProjOffset
		...
		#endregion gvec4 TextureLodOffset (gsampler1D sampler, float P, float lod, int offset)
		...
		#endregion gvec4 TextureLodOffset (gsampler2D sampler, vec2 P, float lod, ivec2 offset)
		...
		#endregion gvec4 TextureLodOffset (gsampler3D sampler, vec3 P, float lod, ivec3 offset)
		...
		#endregion float TextureLodOffset (sampler1DShadow sampler, vec3 P, float lod, int offset)
		...
		#endregion float TextureLodOffset (sampler2DShadow sampler, vec3 P, float lod, ivec2 offset)

		#endregion TextureLodOffset
		...
		#endregion gvec4 TextureProjLod (gsampler1D sampler, vec2 P, float lod)
		...
		#endregion gvec4 TextureProjLod (gsampler1D sampler, vec4 P, float lod)
		...
		#endregion gvec4 TextureProjLod (gsampler2D sampler, vec3 P, float lod)
		...
		#endregion gvec4 TextureProjLod (gsampler2D sampler, vec4 P, float lod)
		...
		#endregion gvec4 TextureProjLod (gsampler3D sampler, vec4 P, float lod)
		...
		#endregion float TextureProjLod (sampler1DShadow sampler, vec4 P, float lod)
		...
		#endregion float TextureProjLod (sampler2DShadow sampler, vec4 P, float lod)

		#endregion TextureProjLod
		...
		#endregion gvec4 TextureProjLodOffset (gsampler1D sampler, vec2 P, float lod, int offset)
		...
		#endregion gvec4 TextureProjLodOffset (gsampler1D sampler, vec4 P, float lod, int offset)
		...
		#endregion gvec4 TextureProjLodOffset (gsampler2D sampler, vec3 P, float lod, ivec2 offset)
		...
		#endregion gvec4 TextureProjLodOffset (gsampler2D sampler, vec4 P, float lod, ivec2 offset)
		...
		#endregion gvec4 TextureProjLodOffset (gsampler3D sampler, vec4 P, float lod, ivec3 offset)
		...
		#endregion float TextureProjLodOffset (sampler1DShadow sampler, vec4 P, float lod, int offset)
		...
		#endregion float TextureProjLodOffset (sampler2DShadow sampler, vec4 P, float lod, ivec2 offset)

		#endregion TextureProjLodOffset
		...
		#endregion gvec4 TextureGrad (gsampler1D sampler, float P, float dPdx, float dPdy)
		...
		#endregion gvec4 TextureGrad (gsampler2D sampler, vec2 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion gvec4 TextureGrad (gsampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy)
		...
		#endregion gvec4 TextureGrad (gsamplerCube sampler, vec3 P, vec3 dPdx, vec3 dPdy)
		...
		#endregion gvec4 TextureGrad (gsampler2DRect sampler, vec2 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion float TextureGrad (sampler2DRectShadow sampler, vec3 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion float TextureGrad (sampler1DShadow sampler, vec3 P, float dPdx, float dPdy)
		...
		#endregion float TextureGrad (sampler2DShadow sampler, vec3 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion float TextureGrad (samplerCubeShadow sampler, vec4 P, vec3 dPdx, vec3 dPdy)

		#endregion TextureGrad
		...
		#endregion gvec4 TextureGradOffset (gsampler1D sampler, float P, float dPdx, float dPdy, int offset)
		...
		#endregion gvec4 TextureGradOffset (gsampler2D sampler, vec2 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion gvec4 TextureGradOffset (gsampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy, ivec3 offset)
		...
		#endregion gvec4 TextureGradOffset (gsampler2DRect sampler, vec2 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion float TextureGradOffset (sampler2DRectShadow sampler, vec3 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion float TextureGradOffset (sampler1DShadow sampler, vec3 P, float dPdx, float dPdy, int offset )
		...
		#endregion float TextureGradOffset (sampler2DShadow sampler, vec3 P, vec2 dPdx, vec2 dPdy, ivec2 offset)

		#endregion TextureGradOffset
		...
		#endregion gvec4 TextureProjGrad (gsampler1D sampler, vec2 P, float dPdx, float dPdy)
		...
		#endregion gvec4 TextureProjGrad (gsampler1D sampler, vec4 P, float dPdx, float dPdy)
		...
		#endregion gvec4 TextureProjGrad (gsampler2D sampler, vec3 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion gvec4 TextureProjGrad (gsampler2D sampler, vec4 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion gvec4 TextureProjGrad (gsampler3D sampler, vec4 P, vec3 dPdx, vec3 dPdy)
		...
		#endregion gvec4 TextureProjGrad (gsampler2DRect sampler, vec3 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion gvec4 TextureProjGrad (gsampler2DRect sampler, vec4 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion float TextureProjGrad (sampler2DRectShadow sampler, vec4 P, vec2 dPdx, vec2 dPdy)
		...
		#endregion float TextureProjGrad (sampler1DShadow sampler, vec4 P, float dPdx, float dPdy)
		...
		#endregion float TextureProjGrad (sampler2DShadow sampler, vec4 P, vec2 dPdx, vec2 dPdy)

		#endregion TextureProjGrad
		...
		#endregion gvec4 TextureProjGradOffset (gsampler1D sampler, vec2 P, float dPdx, float dPdy, int offset)
		...
		#endregion gvec4 TextureProjGradOffset (gsampler1D sampler, vec4 P, float dPdx, float dPdy, int offset)
		...
		#endregion gvec4 TextureProjGradOffset (gsampler2D sampler, vec3 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion gvec4 TextureProjGradOffset (gsampler2D sampler, vec4 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion gvec4 TextureProjGradOffset (gsampler2DRect sampler, vec3 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion gvec4 TextureProjGradOffset (gsampler2DRect sampler, vec4 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion float TextureProjGradOffset (sampler2DRectShadow sampler, vec4 P, vec2 dPdx, vec2 dPdy, ivec2 offset)
		...
		#endregion gvec4 TextureProjGradOffset (gsampler3D sampler, vec4 P, vec3 dPdx, vec3 dPdy, ivec3 offset)
		...
		#endregion float TextureProjGradOffset (sampler1DShadow sampler, vec4 P, float dPdx, float dPdy, int offset)
		...
		#endregion float TextureProjGradOffset (sampler2DShadow sampler, vec4 P, vec2 dPdx, vec2 dPdy, ivec2 offset)

		#endregion TextureProjGradOffset
	}
}
