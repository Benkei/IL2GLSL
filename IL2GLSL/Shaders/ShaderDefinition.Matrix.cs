...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		public sealed class mat2
		{
			...
			public mat2 ( vec4 compressedMatrix )
			{
				throw _invalidAccess;
			}
		...
		public sealed class mat2x3
		{
			...
			public mat2x3 ( vec3 column1, vec3 column2 )
			{
				throw _invalidAccess;
			}
		...
		public sealed class mat2x4
		{
			...
			public mat2x4 ( vec4 column1, vec4 column2 )
			{
				throw _invalidAccess;
			}
		...
		public sealed class mat3x2
		{
			...
			public mat3x2 ( vec2 column1, vec2 column2, vec2 column3 )
			{
				throw _invalidAccess;
			}
		...
		public sealed class mat3x4
		{
			...
			public mat3x4 ( vec4 column1, vec4 column2, vec4 column3 )
			{
				throw _invalidAccess;
			}
