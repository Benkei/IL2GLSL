...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		public sealed class ivec2
		{
			...
			public static ivec2 operator * ( ivec2 v1, int s )
			{
				throw _invalidAccess;
			}
		...
		public sealed class ivec3
		{
			...
			public static ivec3 operator - ( ivec3 v, ivec3 m )
			{
				throw _invalidAccess;
			}
			...
			public static ivec3 operator * ( ivec3 v, int d )
			{
				throw _invalidAccess;
			}
		...
		public sealed class ivec4
		{
			...
			public static ivec4 operator - ( ivec4 v, ivec4 m )
			{
				throw _invalidAccess;
			}
			...
			public static ivec2 operator / ( ivec4 v, int s )
			{
				throw _invalidAccess;
			}

			public static ivec4 operator + ( ivec4 v, int s )
			{
				throw _invalidAccess;
			}
