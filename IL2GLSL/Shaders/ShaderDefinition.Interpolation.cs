...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		...
		protected internal static float InterpolateAtCentroid ( float interpolant )
		{
		...
		/// and the primitive being processed. The value obtained would be the same value assigned to the input variable
		/// if declared with the centroid qualifier.</summary>
		protected internal static vec2 InterpolateAtCentroid ( vec2 interpolant )
		{
			throw _invalidAccess;
		}
		...
		/// and the primitive being processed. The value obtained would be the same value assigned to the input variable
		/// if declared with the centroid qualifier.</summary>
		protected internal static vec3 InterpolateAtCentroid ( vec3 interpolant )
		{
			throw _invalidAccess;
		}
		...
		/// and the primitive being processed. The value obtained would be the same value assigned to the input variable
		/// if declared with the centroid qualifier.</summary>
		protected internal static vec4 InterpolateAtCentroid ( vec4 interpolant )
		{
			throw _invalidAccess;
		}

		#endregion genType InterpolateAtCentroid(genType interpolant)
		...
		protected internal static float InterpolateAtSample ( float interpolant, int sample )
		{
			throw _invalidAccess;
		}
		...
		/// If multisample buffers are not available, the input varying will be evaluated at the center of the pixel.
		/// If sample sample does not exist, the position used to interpolate the input varying is undefined.</summary>
		protected internal static vec2 InterpolateAtSample ( vec2 interpolant, int sample )
		{
			throw _invalidAccess;
		}
		...
		/// If multisample buffers are not available, the input varying will be evaluated at the center of the pixel.
		/// If sample sample does not exist, the position used to interpolate the input varying is undefined.</summary>
		protected internal static vec3 InterpolateAtSample ( vec3 interpolant, int sample )
		{
			throw _invalidAccess;
		}
		...
		/// If multisample buffers are not available, the input varying will be evaluated at the center of the pixel.
		/// If sample sample does not exist, the position used to interpolate the input varying is undefined.</summary>
		protected internal static vec4 InterpolateAtSample ( vec4 interpolant, int sample )
		{
			throw _invalidAccess;
		}

		#endregion genType InterpolateAtSample(genType interpolant, int sample)
		...
		protected internal static float InterpolateAtOffset ( float interpolant, vec2 offset )
		{
			throw _invalidAccess;
		}
		...
		/// directions, respectively. An offset of (0, 0) identifies the center of the pixel.
		/// The range and granularity of offsets supported by this function is implementationdependent.</summary>
		protected internal static vec2 InterpolateAtOffset ( vec2 interpolant, vec2 offset )
		{
			throw _invalidAccess;
		}
		...
		/// directions, respectively. An offset of (0, 0) identifies the center of the pixel.
		/// The range and granularity of offsets supported by this function is implementationdependent.</summary>
		protected internal static vec3 InterpolateAtOffset ( vec3 interpolant, vec2 offset )
		{
			throw _invalidAccess;
		}
		...
		/// directions, respectively. An offset of (0, 0) identifies the center of the pixel.
		/// The range and granularity of offsets supported by this function is implementationdependent.</summary>
		protected internal static vec4 InterpolateAtOffset ( vec4 interpolant, vec2 offset )
		{
			throw _invalidAccess;
		}

		#endregion genType InterpolateAtOffset(genType interpolant, vec2 offset)
	}
}
