...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		public sealed class dvec2
		{
			...
			public static dvec2 operator + ( dvec2 v1, dvec2 v2 )
			{
			...
			public static dvec2 operator * ( dvec2 v1, double s )
			{
				throw _invalidAccess;
			}
			...
			public static dvec2 operator - ( dvec2 v )
			{
				throw _invalidAccess;
			}
		...
		public sealed class dvec3
		{
			...
			public static dvec3 operator - ( dvec3 v, dvec3 m )
			{
				throw _invalidAccess;
			}
			...
			public static dvec3 operator * ( dvec3 v, double d )
			{
				throw _invalidAccess;
			}

			public static dvec3 operator * ( dvec3 v, mat3 m )
			{
				throw _invalidAccess;
			}

			public static dvec3 operator * ( mat3 m, dvec3 v )
			{
				throw _invalidAccess;
			}
			...
			public static dvec3 operator % ( dvec3 v1, double d )
			{
				throw _invalidAccess;
			}
			...
			public static dvec3 operator - ( dvec3 v )
			{
				throw _invalidAccess;
			}
		...
		public sealed class dvec4
		{
			...
			public static dvec4 operator - ( dvec4 v, dvec4 m )
			{
				throw _invalidAccess;
			}
			...
			public static dvec4 operator * ( dvec4 v, mat4 m )
			{
				throw _invalidAccess;
			}

			public static dvec4 operator * ( mat4 m, dvec4 v )
			{
				throw _invalidAccess;
			}

			public static dvec4 operator / ( dvec4 v, double s )
			{
				throw _invalidAccess;
			}

			public static dvec4 operator % ( dvec4 v1, dvec4 v2 )
			{
				throw _invalidAccess;
			}

			public static dvec4 operator % ( dvec4 v1, double d )
			{
				throw _invalidAccess;
			}
			...
			public static dvec4 operator - ( dvec4 v )
			{
				throw _invalidAccess;
			}
