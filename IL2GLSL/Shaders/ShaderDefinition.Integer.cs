...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		...
		#endregion genUType uaddCarry (genUType x, genUType y, out genUType carry)
		...
		#endregion genUType usubBorrow (genUType x, genUType y, out genUType borrow)
		...
		#endregion void umulExtended (genUType x, genUType y, out genUType msb, out genUType lsb)
		...
		#endregion void imulExtended (genIType x, genIType y, out genIType msb, out genIType lsb)
		...
		#endregion genIType bitfieldExtract (genIType value, int offset, int bits)
		...
		#endregion genUType bitfieldExtract (genUType value, int offset, int bits)
		...
		#endregion genIType bitfieldInsert (genIType base, genIType insert, int offset, int bits)
		...
		#endregion genUType bitfieldInsert (genUType base, genUType insert, int offset, int bits)
		...
		/// </summary>
		protected static int bitfieldReverse ( int value )
		{
			throw _invalidAccess;
		}
		...
		/// bit (bits - 1) - n of value, where bits is the total number of bits used to represent value.
		/// </summary>
		protected static ivec2 bitfieldReverse ( ivec2 value )
		{
			throw _invalidAccess;
		}
		...
		/// bit (bits - 1) - n of value, where bits is the total number of bits used to represent value.
		/// </summary>
		protected static ivec3 bitfieldReverse ( ivec3 value )
		{
			throw _invalidAccess;
		}
		...
		#endregion genIType bitfieldReverse (genIType value)
		...
		/// bit (bits - 1) - n of value, where bits is the total number of bits used to represent value.
		/// </summary>
		protected static uint bitfieldReverse ( uint value )
		{
			throw _invalidAccess;
		}
		...
		#endregion genUType bitfieldReverse (genUType value)
		...
		/// <summary>Returns the number of bits set to 1 in the binary representation of value.</summary>
		protected static ivec2 bitCount ( ivec2 value )
		{
			throw _invalidAccess;
		}

		/// <summary>Returns the number of bits set to 1 in the binary representation of value.</summary>
		protected static ivec3 bitCount ( ivec3 value )
		{
			throw _invalidAccess;
		}
		...
		#endregion genIType bitCount (genIType value)

		#region genIType bitCount (genUType value)

		/// <summary>Returns the number of bits set to 1 in the binary representation of value.</summary>
		protected static int bitCount ( uint value )
		{
			throw _invalidAccess;
		}
		...
		#endregion genIType bitCount (genUType value)
		...
		protected static int findLSB ( int value )
		{
			throw _invalidAccess;
		}
		...
		/// <summary> Returns the bit number of the least significant bit set to 1 in the
		/// binary representation of value. If value is zero, -1 will be returned. </summary>
		protected static ivec2 findLSB ( ivec2 value )
		{
			throw _invalidAccess;
		}
		...
		/// <summary> Returns the bit number of the least significant bit set to 1 in the
		/// binary representation of value. If value is zero, -1 will be returned. </summary>
		protected static ivec3 findLSB ( ivec3 value )
		{
			throw _invalidAccess;
		}
		...
		/// <summary> Returns the bit number of the least significant bit set to 1 in the
		/// binary representation of value. If value is zero, -1 will be returned. </summary>
		protected static ivec4 findLSB ( ivec4 value )
		{
			throw _invalidAccess;
		}

		#endregion genIType findLSB (genIType value)

		#region genIType findLSB (genUType value)

		/// <summary> Returns the bit number of the least significant bit set to 1 in the
		/// binary representation of value. If value is zero, -1 will be returned. </summary>
		protected static int findLSB ( uint value )
		{
			throw _invalidAccess;
		}
		...
		#endregion genIType findLSB (genUType value)
		...
		/// </summary>
		protected static int findMSB ( int value )
		{
			throw _invalidAccess;
		}
		...
		/// For a value of zero or negative one, -1 will be returned.
		/// </summary>
		protected static ivec2 findMSB ( ivec2 value )
		{
			throw _invalidAccess;
		}
		...
		/// For a value of zero or negative one, -1 will be returned.
		/// </summary>
		protected static ivec3 findMSB ( ivec3 value )
		{
			throw _invalidAccess;
		}
		...
		#endregion genIType findMSB (genIType value)
		...
		/// </summary>
		protected static int findMSB ( uint value )
		{
			throw _invalidAccess;
		}
		...
		#endregion genIType findMSB (genUType value)
	}
}
