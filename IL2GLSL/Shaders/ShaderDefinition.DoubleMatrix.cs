...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		public sealed class dmat2
		{
			...
			public dmat2 ( vec2 column1, vec2 column2 )
			{
				throw _invalidAccess;
			}

			/// <summary>initialized the matrix with a vec4</summary>
			public dmat2 ( vec4 compressedMatrix )
			{
				throw _invalidAccess;
			}
		...
		public sealed class dmat2x3
		{
			...
			public dmat2x3 ( vec3 column1, vec3 column2 )
			{
				throw _invalidAccess;
			}
		...
		public sealed class dmat2x4
		{
			...
			public dmat2x4 ( vec4 column1, vec4 column2 )
			{
				throw _invalidAccess;
			}
		...
		public sealed class dmat3x2
		{
			...
			public dmat3x2 ( vec2 column1, vec2 column2, vec2 column3 )
			{
				throw _invalidAccess;
			}
		...
		public sealed class dmat3
		{
			...
			public dmat3 ( vec3 column1, vec3 column2, vec3 column3 )
			{
				throw _invalidAccess;
			}
		...
		public sealed class dmat3x4
		{
			...
			public dmat3x4 ( vec4 column1, vec4 column2, vec4 column3 )
			{
				throw _invalidAccess;
			}
