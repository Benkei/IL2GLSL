...
namespace IIS.SLSharp.Shaders
{
	public abstract partial class ShaderDefinition
	{
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected mat2x4 matrixCompMult ( mat2x4 x, mat2x4 y )
		{
			throw _invalidAccess;
		}
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected mat3x2 matrixCompMult ( mat3x2 x, mat3x2 y )
		{
			throw _invalidAccess;
		}
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected mat3x4 matrixCompMult ( mat3x4 x, mat3x4 y )
		{
			throw _invalidAccess;
		}
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected mat4x2 matrixCompMult ( mat4x2 x, mat4x2 y )
		{
			throw _invalidAccess;
		}
		...
		#endregion mat matrixCompMult (mat x, mat y)
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected dmat2 matrixCompMult ( dmat2 x, dmat2 y )
		{
			throw _invalidAccess;
		}
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected dmat2x3 matrixCompMult ( dmat2x3 x, dmat2x3 y )
		{
			throw _invalidAccess;
		}
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected dmat3x2 matrixCompMult ( dmat3x2 x, dmat3x2 y )
		{
			throw _invalidAccess;
		}
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected dmat3x4 matrixCompMult ( dmat3x4 x, dmat3x4 y )
		{
			throw _invalidAccess;
		}
		...
		/// Note: to get linear algebraic matrix multiplication, use the multiply operator (*).
		/// </summary>
		protected dmat4x2 matrixCompMult ( dmat4x2 x, dmat4x2 y )
		{
			throw _invalidAccess;
		}
		...
		#endregion dmat matrixCompMult (dmat x, dmat y)
		...
		/// <returns></returns>
		protected mat2 outerProduct ( vec2 c, vec2 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat3 outerProduct ( vec3 c, vec3 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat4 outerProduct ( vec4 c, vec4 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat2x3 outerProduct ( vec3 c, vec2 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat3x2 outerProduct ( vec2 c, vec3 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat2x4 outerProduct ( vec4 c, vec2 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat4x2 outerProduct ( vec2 c, vec4 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat3x4 outerProduct ( vec4 c, vec3 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected mat4x3 outerProduct ( vec3 c, vec4 r )
		{
			throw _invalidAccess;
		}

		#endregion outerProduct
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected dmat2 outerProduct ( dvec2 c, dvec2 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected dmat3 outerProduct ( dvec3 c, dvec3 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected dmat4 outerProduct ( dvec4 c, dvec4 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected dmat2x3 outerProduct ( dvec3 c, dvec2 r )
		{
			throw _invalidAccess;
		}
		...
		/// <param name="r">right side row vector</param>
		/// <returns></returns>
		protected dmat3x2 outerProduct ( dvec2 c, dvec3 r )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected mat2x3 transpose ( mat3x2 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected mat2x4 transpose ( mat4x2 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected mat4x2 transpose ( mat2x4 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected mat4x3 transpose ( mat3x4 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected dmat2 transpose ( dmat2 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected dmat2x3 transpose ( dmat3x2 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected dmat3x2 transpose ( dmat2x3 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected dmat2x4 transpose ( dmat4x2 m )
		{
			throw _invalidAccess;
		}
		...
		/// The input matrix m is not modified.
		/// </summary>
		protected dmat4x3 transpose ( dmat3x4 m )
		{
			throw _invalidAccess;
		}

		#endregion transpose (double)
		...
		/// <summary>Returns the determinant of m. </summary>
		protected double determinant ( dmat2 m )
		{
			throw _invalidAccess;
		}
